    ...
    return (
        <div className="p-3 overflow-hidden">
            ...
            <div className="flex items-center justify-center cursor-pointer mt-9">
                {!imagePreview && <label htmlFor="fileInput" className="cursor-pointer">
                <input
                    type="file"
                    id="fileInput"
                    accept="image/*"
                ...
                {imagePreview &&
                    <img src={imagePreview} alt="image" className="h-[100px] w-[100px] object-contain" />
                }
            </div>
            {progress > 0 &&<div className="flex justify-center">
